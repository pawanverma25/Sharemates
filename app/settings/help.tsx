...
import { ChevronRight, Mail, MessageCircle, FileText, CircleHelp as HelpCircle } from 'lucide-react-native';
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.item} onPress={handleEmailSupport}>
          ...
          <View style={styles.itemContent}>
            ...
            <Text style={styles.itemDescription}>Get help via email</Text>
          </View>
        ...
        <TouchableOpacity style={styles.item} onPress={handleLiveChat}>
          ...
          <View style={styles.itemContent}>
            ...
            <Text style={styles.itemDescription}>Chat with our support team</Text>
          </View>
          <ChevronRight size={20} color={colors.secondaryText} />
        </TouchableOpacity>
        ...
        {faqs.map((faq, index) => (
          <View key={index} style={styles.faqItem}>
            <Text style={styles.faqQuestion}>
              <HelpCircle size={16} color={colors.primary} /> {faq.question}
            </Text>
