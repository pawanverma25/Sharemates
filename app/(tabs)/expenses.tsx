...
const mockExpenses = [
  {
    ...
    paidBy: 'You',
    group: 'Trip to Paris',
    participants: ['You', 'John', 'Jane', 'Mike'],
  },
  {
    id: 2,
      ...
      {filterVisible && (
        <View style={styles.filterContainer}>
          ...
          <View style={styles.filterOptions}>
            ...
            >
              <Text style={styles.activeFilterOptionText}>Recent</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.filterOption}>
            ...
            >
              ...
              <View style={styles.expenseDetails}>
                ...
                <View style={styles.expenseParticipants}>
                  ...
                  <Text style={styles.expenseParticipantsText}>
