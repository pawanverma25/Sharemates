...
const mockExpenseDetails = {
  ...
  receipt: 'https://images.unsplash.com/photo-1572799454914-d3c2da8ba50d?w=400&fit=crop',
};
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoContent}>
              ...
              <Text style={styles.infoValue}>{expense.group}</Text>
            </View>
          </View>
          <View style={styles.infoRow}>
          ...
          <View style={styles.infoRow}>
            <DollarSign size={20} color={colors.primary} style={styles.infoIcon} />
            <View style={styles.infoContent}>
            ...
            <View key={index} style={styles.splitItem}>
              <View>
                ...
                <Text
                  style={[
                    styles.paidStatus,
                    split.paid ? styles.paidStatusPaid : styles.paidStatusUnpaid,
                  ]}
                >
            ...
            <View style={styles.receiptContainer}>
              ...
              >
                <Text style={styles.settleButtonText}>
                  Download Receipt <Download size={16} color="#fff" />
                </Text>
              </TouchableOpacity>
            </View>
          </View>
